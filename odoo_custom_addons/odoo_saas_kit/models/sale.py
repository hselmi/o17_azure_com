    ...
    def process_contract(self):
        for order in self:
            ...
            for contract_line in all_contract_lines:
                ...
                check_trial_plan = self.env['saas.plan'].search([('id', '=', contract_product.saas_plan_id.id)])
                _logger.info(f"====is_trial_plan======{'trial_product' in check_trial_plan._fields}=============")
                if not 'trial_product' in check_trial_plan._fields:
                ...
                vals = dict(
                    ...
                    trial_period=relative_delta.days,
                    remaining_cycles=0,
