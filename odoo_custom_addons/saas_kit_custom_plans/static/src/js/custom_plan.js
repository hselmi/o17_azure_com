...
publicWidget.registry.CustomPlan = publicWidget.Widget.extend({
    ...
    _toggle_selected_apps: function () {
        for (var app in apps) {
            ...
            $(app).css({ 'background': '#3AADAA;', 'border': '1px solid #3AADAA' });
    ...
    change_app_card: function(ev){
        ...
        $(ev.currentTarget).closest('.app_card').css({'background': 'rgb(58, 173, 170)', 'border': '1px solid '});
    ...
    remote_from_side_panel : function(ev){
        ...
        $(ev.currentTarget).closest('.app_card').css({'background': 'rgb(255,255,255)', 'border': '1px solid #CCCCC'});
